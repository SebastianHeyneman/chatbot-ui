...
AS $$
DECLARE
  project_url TEXT := 'https://lhhaexyrpwmhhjmkveqj.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxoaGFleHlycHdtaGhqbWt2ZXFqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxODI0ODY1OCwiZXhwIjoyMDMzODI0NjU4fQ.02YRjxytCqJZRPde3jIobOPRx88mvbNGvEmpJbn45Tg'; -- full access needed for http request to storage
